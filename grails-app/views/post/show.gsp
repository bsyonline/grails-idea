	...
	<body>
		...
		<div id="show-post" class="content scaffold-show" role="main">
			...
			<ol class="property-list post">
				...
				<g:if test="${postInstance?.publisher}">
				<li class="fieldcontain">
					<span id="publisher-label" class="property-label"><g:message code="post.publisher.label" default="Publisher" /></span>
					
						<span class="property-value" aria-labelledby="publisher-label"><g:fieldValue bean="${postInstance}" field="publisher"/></span>
				...
				<g:if test="${postInstance?.pic}">
				<li class="fieldcontain">
					<span id="pic-label" class="property-label"><g:message code="post.pic.label" default="Pic" /></span>
					
						<span class="property-value" aria-labelledby="pic-label"><g:fieldValue bean="${postInstance}" field="pic"/></span>
