	...
	<body>
		...
		<div id="show-project" class="content scaffold-show" role="main">
			...
			<ol class="property-list project">
				...
				<g:if test="${projectInstance?.x}">
				<li class="fieldcontain">
					<span id="x-label" class="property-label"><g:message code="project.x.label" default="X" /></span>
					
						<span class="property-value" aria-labelledby="x-label"><g:fieldValue bean="${projectInstance}" field="x"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${projectInstance?.y}">
				<li class="fieldcontain">
					<span id="y-label" class="property-label"><g:message code="project.y.label" default="Y" /></span>
					
						<span class="property-value" aria-labelledby="y-label"><g:fieldValue bean="${projectInstance}" field="y"/></span>
